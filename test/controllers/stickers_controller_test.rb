...
class StickersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sticker" do
    assert_difference("Sticker.count") do
      post stickers_url, params: { sticker: { code: @sticker.code, description: @sticker.description, picture: @sticker.picture } }
    end
  ...
  test "should update sticker" do
    patch sticker_url(@sticker), params: { sticker: { code: @sticker.code, description: @sticker.description, picture: @sticker.picture } }
